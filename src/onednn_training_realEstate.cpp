...
void simple_net(engine::kind engine_kind)
{
        ...
        unsigned long samples = 414;
        // Load dataset
        auto dataset_path = "data/features_realEstate.txt";

        std::vector<unsigned long> dataset_shape = {samples, 6};      //Real estate dataset
        ...
        // Load labels
        auto labels_path = "data/label_realEstate.txt";
